...
| qa-tester subagent (executor half of QA writer/executor split per [ADR-0020](decisions/0020-qa-automation-writer-executor.md); dispatched by the `/qa-plan` writer skill) | `.claude/agents/qa-tester.md` | `cat .claude/agents/qa-tester.md` |
