...
[`decisions/`](decisions/) holds 62 ADR(s). See [`decisions/README.md`](decisions/README.md) for the full index.
...
> **Auto-generated component counts** (as of last generator run): 11 skill(s), 7 critic(s) + 3 generator(s), 15 hook(s), 62 ADR(s).
