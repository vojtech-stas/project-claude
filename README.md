...
[`decisions/`](decisions/) holds 80 ADR(s). See [`decisions/README.md`](decisions/README.md) for the full index.
...
> **Auto-generated component counts** (as of last generator run): 6 skill(s), 6 critic(s) + 3 generator(s), 8 hook(s), 80 ADR(s).
