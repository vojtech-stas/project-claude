...
- **[`workflow event logger`](.claude/settings.json)** (`PreToolUse · Skill`) — logs workflow event to workflow-events.jsonl
...
- **[`workflow event logger`](.claude/settings.json)** (`PostToolUse · AskUserQuestion`) — logs workflow event to workflow-events.jsonl
