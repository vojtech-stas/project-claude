...
[`decisions/`](decisions/) holds 53 ADR(s). See [`decisions/README.md`](decisions/README.md) for the full index.
...
> **Auto-generated component counts** (as of last generator run): 11 skill(s), 7 critic(s) + 3 generator(s), 9 hook(s), 53 ADR(s).
