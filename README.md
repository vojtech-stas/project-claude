...
- **[`codebase-critic`](.claude/agents/codebase-critic.md)** — Audit the cumulative change of a whole PRD for codebase-level coherence, fired by /ship at the last open slice before the reviewer pass.
...
- **[`codebase-critic`](.claude/agents/codebase-critic.md)** — Audit the cumulative change of a whole PRD for codebase-level coherence, fired by /ship at the last open slice before the reviewer pass. Reviews the PRD base..last-slice-HEAD diff for semantic reference currency, architectural drift, and refactoring opportunities. Emits a CRITIC trailer (VERDICT/REASON/ROUND). Read-only; does not merge.
...
- **[`log-event`](.claude/hooks/log-event.sh)** (`PreToolUse · Agent`) — log-event.sh — canonical event-log appender (ADR-0016 / PRD #467 / slice #468).
- **[`log-event`](.claude/hooks/log-event.sh)** (`PreToolUse · Skill`) — log-event.sh — canonical event-log appender (ADR-0016 / PRD #467 / slice #468).
...
- **[`log-event`](.claude/hooks/log-event.sh)** (`PostToolUse · Agent`) — log-event.sh — canonical event-log appender (ADR-0016 / PRD #467 / slice #468).
- **[`log-event`](.claude/hooks/log-event.sh)** (`PostToolUse · Bash`) — log-event.sh — canonical event-log appender (ADR-0016 / PRD #467 / slice #468).
- **[`log-event`](.claude/hooks/log-event.sh)** (`PostToolUse · AskUserQuestion`) — log-event.sh — canonical event-log appender (ADR-0016 / PRD #467 / slice #468).
- **[`log-event`](.claude/hooks/log-event.sh)** (`Stop`) — log-event.sh — canonical event-log appender (ADR-0016 / PRD #467 / slice #468).
...
[`decisions/`](decisions/) holds 49 ADR(s). See [`decisions/README.md`](decisions/README.md) for the full index.
...
> **Auto-generated component counts** (as of last generator run): 11 skill(s), 7 critic(s) + 3 generator(s), 9 hook(s), 49 ADR(s).
