...
- **Health** — DOCS-1..DOCS-10 audit-meta grid, AS-* audit-subagents grid, substrate health rows (CAPTURE-SLO, HOOK-INTEGRITY, ISOLATION-GROUP), cascade-finder status. Click any FAIL row to expand details.
