...
| [0010](0010-implementer-subagent-auto-pipeline.md) | Implementer subagent + /ship auto-invoke closes ADR-0003 D4's autonomy gap | Accepted (isolation mechanism for D3 parallel dispatch added by ADR-0035) |
