...
summary: PostToolUse + PreToolUse + UserPromptSubmit + Stop hooks per ADR-0015 D2 scope policy; logging/validation/notification only; cannot invoke skills/subagents.
