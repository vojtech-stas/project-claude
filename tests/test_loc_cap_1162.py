...
class TestGenRulesBaseline(unittest.TestCase):
    ...
    def test_baseline_bumped_to_82(self):
        ...
        # slice #1197). This test's job is unchanged: confirm slice #1162's
        # own PIP-020/021 rule_ids are still represented in the live
        # baseline, not that the literal number stays frozen at 82.
        self.assertIn("RULE_IDS_BASELINE: int = 84", self.text)
